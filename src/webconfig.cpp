...
std::string setAddonOptions()
{
    ...
    FightpadESP32ProxyOptions& fightpadESP32ProxyOptions = Storage::getInstance().getAddonOptions().fightpadESP32ProxyOptions;
    docToValue(fightpadESP32ProxyOptions.enabled, doc, "FightpadESP32ProxyAddonEnabled");
    docToValue(fightpadESP32ProxyOptions.uartBlock, doc, "fightpadESP32ProxyUartBlock");
    docToValue(fightpadESP32ProxyOptions.baud, doc, "fightpadESP32ProxyBaud");
    docToPin(fightpadESP32ProxyOptions.resetPin, doc, "fightpadESP32ProxyResetPin");
    docToPin(fightpadESP32ProxyOptions.bootPin, doc, "fightpadESP32ProxyBootPin");
    docToPin(fightpadESP32ProxyOptions.txPin, doc, "fightpadESP32ProxyTxPin");
    docToPin(fightpadESP32ProxyOptions.rxPin, doc, "fightpadESP32ProxyRxPin");
    docToPin(fightpadESP32ProxyOptions.ctsPin, doc, "fightpadESP32ProxyCtsPin");
    docToPin(fightpadESP32ProxyOptions.rtsPin, doc, "fightpadESP32ProxyRtsPin");
    docToValue(fightpadESP32ProxyOptions.useFlowControl, doc, "fightpadESP32ProxyUseFlowControl");
    docToValue(fightpadESP32ProxyOptions.autoDtrRts, doc, "fightpadESP32ProxyAutoDtrRts");
...
{
    const size_t capacity = JSON_OBJECT_SIZE(520);
    DynamicJsonDocument doc(capacity);
    ...
    const FightpadESP32ProxyOptions& fightpadESP32ProxyOptions = Storage::getInstance().getAddonOptions().fightpadESP32ProxyOptions;
    writeDoc(doc, "FightpadESP32ProxyAddonEnabled", fightpadESP32ProxyOptions.enabled);
    writeDoc(doc, "fightpadESP32ProxyUartBlock", fightpadESP32ProxyOptions.uartBlock);
    writeDoc(doc, "fightpadESP32ProxyBaud", fightpadESP32ProxyOptions.baud);
    writeDoc(doc, "fightpadESP32ProxyResetPin", cleanPin(fightpadESP32ProxyOptions.resetPin));
    writeDoc(doc, "fightpadESP32ProxyBootPin", cleanPin(fightpadESP32ProxyOptions.bootPin));
    writeDoc(doc, "fightpadESP32ProxyTxPin", cleanPin(fightpadESP32ProxyOptions.txPin));
    writeDoc(doc, "fightpadESP32ProxyRxPin", cleanPin(fightpadESP32ProxyOptions.rxPin));
    writeDoc(doc, "fightpadESP32ProxyCtsPin", cleanPin(fightpadESP32ProxyOptions.ctsPin));
    writeDoc(doc, "fightpadESP32ProxyRtsPin", cleanPin(fightpadESP32ProxyOptions.rtsPin));
    writeDoc(doc, "fightpadESP32ProxyUseFlowControl", fightpadESP32ProxyOptions.useFlowControl);
    writeDoc(doc, "fightpadESP32ProxyAutoDtrRts", fightpadESP32ProxyOptions.autoDtrRts);

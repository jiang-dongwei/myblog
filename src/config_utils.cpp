...
void ConfigUtils::initUnsetPropertiesWithDefaults(Config& config)
{
    ...
    // addonOptions.fightpadESP32ProxyOptions
    INIT_UNSET_PROPERTY(config.addonOptions.fightpadESP32ProxyOptions, enabled, !!FIGHTPAD12SLIM_ESP32_PROXY_ENABLED);
    INIT_UNSET_PROPERTY(config.addonOptions.fightpadESP32ProxyOptions, uartBlock, FIGHTPAD12SLIM_ESP32_PROXY_UART_BLOCK);
    INIT_UNSET_PROPERTY(config.addonOptions.fightpadESP32ProxyOptions, baud, FIGHTPAD12SLIM_ESP32_PROXY_UART_BAUD);
    INIT_UNSET_PROPERTY(config.addonOptions.fightpadESP32ProxyOptions, resetPin, FIGHTPAD12SLIM_ESP32_PROXY_RESET_PIN);
    INIT_UNSET_PROPERTY(config.addonOptions.fightpadESP32ProxyOptions, bootPin, FIGHTPAD12SLIM_ESP32_PROXY_BOOT_PIN);
    INIT_UNSET_PROPERTY(config.addonOptions.fightpadESP32ProxyOptions, txPin, FIGHTPAD12SLIM_ESP32_PROXY_UART_TX_PIN);
    INIT_UNSET_PROPERTY(config.addonOptions.fightpadESP32ProxyOptions, rxPin, FIGHTPAD12SLIM_ESP32_PROXY_UART_RX_PIN);
    INIT_UNSET_PROPERTY(config.addonOptions.fightpadESP32ProxyOptions, ctsPin, FIGHTPAD12SLIM_ESP32_PROXY_UART_CTS_PIN);
    ...
    INIT_UNSET_PROPERTY(config.addonOptions.fightpadAmbientLEDOptions, brightnessLevel, 0);
    INIT_UNSET_PROPERTY(config.addonOptions.fightpadAmbientLEDOptions, manualLightEffectsEnabled, true);
    INIT_UNSET_PROPERTY(config.addonOptions.fightpadAmbientLEDOptions, allLightsEnabled, true);
...
void gpioMappingsMigrationCore(Config& config)
{
    ...
    if (config.addonOptions.fightpadESP32ProxyOptions.enabled) {
        markAddonPinIfUsed(config.addonOptions.fightpadESP32ProxyOptions.resetPin);
        markAddonPinIfUsed(config.addonOptions.fightpadESP32ProxyOptions.bootPin);
        markAddonPinIfUsed(config.addonOptions.fightpadESP32ProxyOptions.txPin);
        markAddonPinIfUsed(config.addonOptions.fightpadESP32ProxyOptions.rxPin);
        if (config.addonOptions.fightpadESP32ProxyOptions.useFlowControl) {
            markAddonPinIfUsed(config.addonOptions.fightpadESP32ProxyOptions.ctsPin);
            markAddonPinIfUsed(config.addonOptions.fightpadESP32ProxyOptions.rtsPin);
        }
    }

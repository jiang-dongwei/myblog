export default {
	...
	'fightpad-esp32-proxy-header-text': 'Fightpad ESP32-C6 Bluetooth Proxy',
	'fightpad-esp32-proxy-sub-header-text':
		'RP2350 USB CDC to ESP32-C6 UART bridge. The USB CDC interface itself is enabled by the Fightpad firmware build.',
	'fightpad-esp32-proxy-uart-block-label': 'UART Block',
	'fightpad-esp32-proxy-baud-label': 'UART Baud',
	'fightpad-esp32-proxy-reset-pin-label': 'ESP32-C6 RESET/EN GPIO Pin',
	'fightpad-esp32-proxy-boot-pin-label': 'ESP32-C6 BOOT GPIO Pin',
	'fightpad-esp32-proxy-tx-pin-label': 'RP2350 UART TX GPIO Pin',
	'fightpad-esp32-proxy-rx-pin-label': 'RP2350 UART RX GPIO Pin',
	'fightpad-esp32-proxy-cts-pin-label': 'RP2350 UART CTS GPIO Pin',
	'fightpad-esp32-proxy-rts-pin-label': 'RP2350 UART RTS GPIO Pin',
	'fightpad-esp32-proxy-flow-control-label': 'Use UART Flow Control',
	'fightpad-esp32-proxy-auto-dtr-rts-label': 'Use DTR/RTS for BOOT/RESET',
};
